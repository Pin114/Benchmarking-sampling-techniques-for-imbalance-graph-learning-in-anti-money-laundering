...
if __name__ == "__main__":
    ...
    # ========== 1. ratio analysis ==========
    print("\n" + "=" * 100)
    print("1️⃣  Class Imbalance Ratio Analysis (Verify APATE Hypothesis)")
    print("=" * 100)
    ...
    for idx, (ratio, row) in enumerate(ratio_stats.iterrows(), 1):
        ...
        print(f"\n{symbol} {idx}. {ratio:8} → Mean: {row['mean']:.6f}, Std Dev: {row['std']:.6f} {f'({improvement:+.1f}%)' if improvement != 0 else ''}")
    
    # ========== 2. sampling technique analysis ==========
    print("\n" + "=" * 100)
    print("2️⃣  Sampling Technique Effectiveness Analysis")
    print("=" * 100)
    ...
    # ========== 3. method analysis ==========
    print("\n" + "=" * 100)
    print("3️⃣  Method Performance Comparison")
    print("=" * 100)
    ...
    print("\n" + "=" * 100)
    print("4️⃣  Best and Worst Combinations Ranking")
    print("=" * 100)
    ...
    # ========== 5. cross analysis ==========
    print("\n" + "=" * 100)
    print("5️⃣  Cross Analysis: Ratio × Sampling Technique")
    print("=" * 100)
    ...
    print("\n" + "=" * 100)
    print("6️⃣  Method Performance Detailed Comparison: Classified by Ratio")
    print("=" * 100)
    ...
    if ratio_means.index[0] == "2:1":
        ...
        print(f"\n⚠️  Conclusion: {ratio_means.index[0]} Performs Best, Different from APATE Hypothesis")
